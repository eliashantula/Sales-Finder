...
const baseUrl = "https://spoonacular-recipe-food-nutrition-v1.p.rapidapi.com/recipes/findByIngredients?number=2&ranking=1&ingredients="
...
app.get('/api/recipe', (req, res, next) => {
  console.log('Requesting data from Spoonacular...')
